    ...
    >
        ...
        <View style={layoutStyle.columnsInside}>
          <View style={[layoutStyle.cols_75, layoutStyle.lPaddingS]}>
            <Text style={[layoutStyle.mediumText, { color: selectedTheme.textPrimary }]}>
              {item.name}
            </Text>
          </View>
          <View
        ...
        {type === 'store' && item.location && (
          ...
          <View style={layoutStyle.columnsInside}>
            <Text
              style={[layoutStyle.smallText, layoutStyle.lPaddingS, { color: selectedTheme.textSecondary }]}
            >
              {item.description}
            </Text>
          </View>
          ...
          {[
            ...
            >
              ...
              >
                ...
                <Text
                  style={[layoutStyle.smallText, { color: selectedTheme.textDark, marginLeft: 5 }]}
                >
                  {comment.user}
                </Text>
              </View>
              <View style={commonStyle.commentWrapper}>
                ...
                <View style={commonStyle.timeAndReactionWrapper}>
                  ...
                  <Text style={[layoutStyle.xSmallText, layoutStyle.lPaddingS, { color: selectedTheme.textBlur }]}>
                    |
                  </Text>
                  <TouchableOpacity
